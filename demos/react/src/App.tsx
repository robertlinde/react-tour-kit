			...
			<main className='main'>
				<section className='settings-section'>
					...
					<div className='setting-card' data-tour='theme-toggle'>
						...
						<button type='button' className='toggle-button'>Toggle</button>
					</div>
					...
					<div className='setting-card' data-tour='notifications'>
						...
						<button type='button' className='toggle-button'>Configure</button>
					</div>
					...
					<div className='setting-card'>
						...
						<button type='button' className='toggle-button'>English</button>
					</div>
				</section>
			</main>
		</div>
